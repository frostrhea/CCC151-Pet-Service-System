...
CREATE TABLE `tblappointment_history` (
  ...
  KEY `petID_idx` (`petID`),
  KEY `serviceIDforeign_idx` (`serviceID`),
  CONSTRAINT `petIDforeign` FOREIGN KEY (`petID`) REFERENCES `tblpet` (`petID`),
  CONSTRAINT `serviceIDforeign` FOREIGN KEY (`serviceID`) REFERENCES `tblservice` (`serviceID`)
...
CREATE TABLE `tblappointment_service` (
  ...
  CONSTRAINT `appforeignID` FOREIGN KEY (`appointmentID`) REFERENCES `tblappointment_history` (`appointmentID`),
...
CREATE TABLE `tblowner` (
  ...
  CONSTRAINT `petID` FOREIGN KEY (`ownerID`) REFERENCES `tblpet` (`petID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tblpet` (
  ...
  CONSTRAINT `ownIDforeign` FOREIGN KEY (`ownerID`) REFERENCES `tblowner` (`ownerID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-27 21:17:03
